 ...
 * [Labs.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Labs.newInstance] factory method to
...
class Labs : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment Labs.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): Labs {
            val fragment = Labs()
            val args = Bundle()
